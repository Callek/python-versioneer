...
* CI: Run mypy only with lowest and highest supported CPython. by @Callek (#385)
* CI: Set required Git configurations in tox.ini rather than rely on system. by @Callek (#385)
